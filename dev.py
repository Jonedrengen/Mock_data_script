...
class CPRprovider(BaseProvider): # -> CPRprovider class inherits from BaseProvider, which is a class from the faker module, that enables us to create custom providers
